  ...
  <Layout title="플로브 - 나의 눈을 위한 안경 큐레이션 서비스">
    <div className="indexWrap">
      ...
      <div className="top">
        <div className="banner">
          <a href="/2020-winter-event">[안경 기부 이벤트] 최대 8만원 할인 혜택<strong><span> &#xE001;</span></strong></a>
        </div>
        <div className="con">
          <div className="inner">
            <p className="txt">나의 눈을 위한<br/>안경 큐레이션 서비스</p>
            <button className="cta">플로브 시작하기</button>
          </div>
    ...
    <div className="topBanner">
                <a href="/2020-winter-event">
                  <p className="gtm-003">[안경 기부 이벤트] 최대 8만원 할인 혜택<strong><span style={{ margin: '0 0 0 3px' }}> &#xE001;</span></strong></p>
                </a>
              </div>
              ...
              <div className="section top">
                <div className="inner">
                  <div style={{ padding: '0 24px' }}>
                    <p style={{ padding: '144px 0 0 0', color: '#fff', fontSize: '30px'}}>나의 눈을 위한<br />안경 큐레이션 서비스</p>
                    <a className="gtm-001" style={{ display: 'inline-block', marginTop: '16px', background: '#c3512a', borderRadius: '32px', fontSize: '16px', color: '#fff', padding: '12px 20px' }}>플로브 시작하기</a>
                  </div>
                </div>
                <div className="scroll-arrow"><div className="img"><img src="/static/img/newLanding/vv_w.png" alt="" /></div></div>
              </div>

              <div className="section pod">
                <div className="inner" style={{ padding: '0 24px' }}>
                  <p className="fontR" style={{ lineHeight: '1.13', fontSize: '32px', wordBreak: 'keep-all', color: '#64433f' }}>we care. we listen. we recommend.</p>
                  <p style={{ marginTop: '16px', fontSize: '16px', color: '#64433f' }}>수많은 안경 속, 나에게 맞는 안경은 어떤 것일까 고민한 적 있으신가요?<br />눈 건강과 라이프스타일을 반영한 플로브 큐레이션을 경험하세요.</p>
                </div>
              </div>
              ...
              <div className="section bottom">
                <div className="inner">
                  <div className="cta-bottom"><a className="gtm-002" href="/survey">플로브 시작하기</a></div>
                </div>
              </div>

              <div className="section company">
                <p style={{ fontSize: '16px', color: '#33373a' }}>(주)씨에이치스퀘어 사업자 정보</p>
                <ul style={{ marginTop: '20px', paddingBottom: '16px' }}>
                  <li><span>대표자명</span><span>천영환</span></li>
                  <li><span>사업자등록번호</span><span>699-86-01370</span></li>
                  <li><span>통신판매업신고</span><span>2019-서울강남-02689</span></li>
                  <li><span>주소</span><span>서울시 강남구 테헤란로4길 38-5, 6층</span></li>
                  <li><span>전화/이메일</span><span><span style={{ paddingLeft: '0' }} >1544-8767</span> | contact@floev.com</span></li>
                  <li><span>개인정보책임자</span><span>엄태산</span></li>
                </ul>
                <div style={{ marginTop: '12px', marginBottom: '8px ' }}>
                  <a href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=6998601370" target="_blank"><span>사업자정보확인</span></a>
                    |
                    <a href="/service-policy"><span>서비스 정책 안내</span></a>
                </div>
              </div>
    </div>

				...
				<div className="indexPage">
					...
					<div className="lounge">
						...
						<div className="lounge__list">
							...
							<div className="lounge__thumb"><div><img src="/static/img/newLanding/lounge_g_0.png" alt="" /></div></div>
						</div>
					</div>

					<div className="faq">
						<div className="faq__title"><strong><p>플로브에게 물어봥</p></strong></div>
						<div className="faq__caption"><p>여기 있으니까 한 번 봐봐</p></div>

...
const CompletePage = (props: {
    ...
    return (<>
        ...
        <div className="contentWrap">
            <p className="qDesc3">{props.user === null ? '' : props.user.name}님 <strong>서비스 예약 일정</strong>은<br />
                <strong>1월 19일 화요일 오전 11:01</strong><br />
                <strong>예약 라운지</strong>는 역삼성당입니다.<br />
            </p>

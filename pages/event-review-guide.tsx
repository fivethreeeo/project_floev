    ...
    <Layout title="플로브 - 나의 눈을 위한 안경 큐레이션 서비스">
      ...
      <div className="wrap">
        ...
        <div className="clearDiv">
          ...
          <div style={{ float: 'right', width: '115px' }}><img src="/img/newLanding/kakao-naver-app.png" alt="네이버맵, 카카오맵" /></div>
        </div>
        ...
        <div>
          ...
          <div style={{ margin: '16px 0' }} className="clearDiv">
            <div className="clearDiv" style={{ width: 'calc( 50% - 8px )', float: 'left', marginRight: '8px' }}>
              ...
              <div style={{ float: 'left', width: '100%', marginTop: '6px' }}><img src="/img/newLanding/naver-map-1.png" alt="네이버 맵 - MY 플레이스 클릭" /></div>
            </div>
            <div className="clearDiv" style={{ width: 'calc( 50% - 8px )', float: 'left', marginLeft: '8px' }}>
              ...
              <div style={{ float: 'left', width: '100%', marginTop: '6px' }}><img src="/img/newLanding/naver-map-2.png" alt="영수증 인증 리뷰하기 클릭하고 영수증 사진 촬영하면 끝!" /></div>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginTop: '48px' }}>
          ...
          <div style={{ margin: '16px 0' }} className="clearDiv">
            <div className="clearDiv" style={{ width: 'calc( 50% - 8px )', float: 'left', marginRight: '8px' }}>
              ...
              <div style={{ float: 'left', width: '100%', marginTop: '6px' }}><img src="/img/newLanding/kakao-map-3.png" alt="네이버 맵 - MY 플레이스 클릭" /></div>
            </div>
            <div className="clearDiv" style={{ width: 'calc( 50% - 8px )', float: 'left', marginLeft: '8px' }}>
              ...
              <div style={{ float: 'left', width: '100%', marginTop: '6px' }}><img src="/img/newLanding/kakao-map-2.png" alt="플로브라운지 역삼성당/강남 클릭하고 하단 별점리뷰 등록하면 끝!" /></div>
            </div>
          </div>
        </div>

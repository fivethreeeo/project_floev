      ...
      <div className="wrap">
        <div className="loungeWrap global640">
          ...
          <div className="section">
            <div className="imgWrap"><img src="/img/newLanding/lounge-g-2.jpg" alt="" /></div>
          ...
          <div className="section">
            <div className="imgWrap"><img src="/img/newLanding/lounge-g-5.jpg" alt="" /></div>
          ...
          <div className="section">
            <div className="imgWrap"><img src="/img/newLanding/lounge-g-6.jpg" alt="" /></div>
        ...
        <style jsx>{`
          ...
          .title .imgWrap {float:none;width:100%;height:640px;overflow:hidden;background:url(/img/newLanding/lounge-g-1.jpg) center center / cover no-repeat}

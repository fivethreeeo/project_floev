      ...
      <div className="wrap">
        <div className="loungeWrap global640">
          ...
          <div className="section">
            <div className="imgWrap"><img src="/img/newLanding/lounge-y-2.jpg" alt="" /></div>
            <p>기존 안경원이 가진 특유의 딱딱한 판매 공간이 아닌 <strong>눈 맞추고 대화하는 것에 집중하여 나의 눈을 정확하게 알고 필요한 선택을 충분히 고민할 수 있는 공간</strong>을 만들고 싶었어요.</p>
          </div>

          <div className="section">
            <div className="imgWrap"><img src="/img/newLanding/lounge-y-3.jpg" alt="" /></div>
          ...
          <div className="section">
            <div className="imgWrap"><img src="/img/newLanding/lounge-y-4.jpg" alt="" /></div>
        ...
        <style jsx>{`
          ...
          .title .imgWrap {float:none;width:100%;height:640px;overflow:hidden;background:url(/img/newLanding/lounge-y-1.jpg) center center / cover no-repeat}

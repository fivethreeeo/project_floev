      ...
      <div className="wrap">
        ...
        <div className="brandWrap">
          ...
          <div className="titWrap">
            ...
            <div className="titImg"><img src="/img/brd/01rj-tit-big-1.jpg" alt="" /></div>
          </div>
          ...
          <div className="descWrap">
            ...
            <div className="mainImg"><img src="/img/brd/01rj-tit-big-1.jpg" alt="" /></div>
            ...
            <div className="subImg"><img src="/img/brd/01rj-desc-big-1.jpg" alt="" /></div>

    ...
    return (
        ...
        <div className="wrap">
          ...
          <div className="titWrap">
              ...
              <div className="titImg"><img src="/static/img/brd/01ik-tit-big-1.jpg" alt=""/></div>
            </div>
            ...
            <div className="descWrap">
              ...
              <div className="mainImg"><img src="/static/img/brd/01ik-tit-big-1.jpg" alt=""/></div>
              ...
              <div className="subImg"><img src="/static/img/brd/01ik-desc-big-1.jpg" alt=""/></div>

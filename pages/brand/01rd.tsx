      ...
      <div className="wrap">
        ...
        <div className="brandWrap">
          ...
          <div className="titWrap">
            ...
            <div className="titImg"><img src="/img/brd/01rd-tit-big-1.jpg" alt="" /></div>
          </div>
          ...
          <div className="descWrap">
            ...
            <div className="mainImg"><img src="/img/brd/01rd-tit-big-1.jpg" alt="" /></div>
            <h3 className="mainTxt">존 레논, 이 세상 모든 둥근테의 오리지널</h3>
            <p className="mainDesc">예술가가 떠난 자리에는 두 가지가 남습니다. 작품이 남고, ‘스타일’이 남습니다. 팬덤이 예술가의 얼을 이어받아 스타일을 발전시키죠. 시대를 초월한 패션 스타일을 오늘날의 라이프 스타일에 맞춰 재해석하는 것. 메이커가 엉뚱한 헤리티지를 정식으로 구입해 새로운 브랜드로 론칭하는 이유입니다. 프랑스의 반백년 안경메이커 KNCO가 정식으로 ‘존 레논'의 저작권을 사들였습니다.</p>
            <div className="subImg"><img src="/img/brd/01rd-desc-big-1.jpg" alt="" /></div>

    ...
    return (
        ...
        <div className="wrap">
          ...
          <div className="titWrap">
              ...
              <div className="titImg"><img src="/static/img/brd/01iy-tit-big-1.jpg" alt=""/></div>
            </div>
            ...
            <div className="descWrap">
              ...
              <div className="mainImg"><img src="/static/img/brd/01iy-tit-big-1.jpg" alt=""/></div>
              ...
              <div className="subImg"><img src="/static/img/brd/01iy-desc-big-1.jpg" alt=""/></div>

    ...
    return (<>
                <div className="q-wrap q9">
                    ...
                    <div className="q-wrap__answer-wrap">
                        <textarea className="q-wrap__textarea" placeholder="원하는 분위기, 스타일, 기피 색상, 기피 스타일, 불편해도 스타일리쉬하게, 무조건 편한거, 선호하는 브랜드 등" value={prefer} onChange={(e) => handleChange(e)}></textarea>

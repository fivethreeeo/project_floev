    ...
    return (<>
        <div className="contentWrap">
            ...
            <div className="answerWrap">
                <input type="text" name="size1" placeholder={'45'} value={size1} maxLength={2} onChange={e => handleChange1(e.target.value)} />
                <input type="text" name="size2" placeholder={'24'} value={size2} maxLength={2} onChange={e => handleChange2(e.target.value)} />
                <input type="text" name="size3" placeholder={'145'} value={size3} maxLength={3} onChange={e => handleChange3(e.target.value)} />
            </div>
        </div>

        ...
        <div className="q-wrap q8">
            ...
            <div className="q-wrap__btn-wrap">
                ...
                {painTypes.length === 0 && painTypesEtc.length === 0 ? (
                    ...
                    (<button className="q-wrap__btn q-wrap__btn-next tn-q-8-2" type="button" onClick={() => props.onNext()}><span>다음</span> <img src="static/img/survey/ic-arrows-right.png" alt="" /></button>)
                }
            </div>
        </div>

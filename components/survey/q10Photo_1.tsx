        ...
        <div className="q-wrap q10">
            ...
            <div className="q-wrap__btn-wrap">
                ...
                {photoFileList.length === 0 ? (
                    ...
                    (<button className="q-wrap__btn q-wrap__btn-next tn-q-10-1" type="button" onClick={() => props.onNext()}><span>다음</span> <img src="static/img/survey/ic-arrows-right.png" alt="" /></button>)
                }
            </div>
        </div>
    </>)

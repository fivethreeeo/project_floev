...
export default function Q7PainDegree(props: {
    ...
    return (<>
                <div className="q-wrap q7">
                    <div className="q-wrap__question-main">안경/콘택트렌즈를 착용하지 않고 일상적인 생활이 어느정도 가능하신가요?</div>
                    <div className="q-wrap__answer-wrap" onChange={(e) => handleChangePainDegree(e)}>
                        ...
                        <input className="q-wrap__input-radio" type="radio" id="q7_4" onChange={() => { }} value={PAINDEGREE.NEVER} checked={painDegree === PAINDEGREE.ALWAYS} />
                        ...
                        <div className="q-wrap__textarea-wrap">
                            <div className="q-wrap__textarea-question">*그 외 어려움이나 구체적인 상황을 더 들려주세요</div>
                            <textarea className="q-wrap__textarea" value={painDegreeEtc} onChange={(e) => handleChangePainDegreeEtc(e)} 

...
import preferFrameColors from './preferFrameColors'
import preferFrameShapes from './preferFrameShapes'
import preferLensShapes from './preferLensShapes'
import preferMoods from './preferMoods'
...
const steps = [
    ...
    preferFrameColors, preferFrameShapes, preferLensShapes, preferMoods,
    Q9Prefer,
    Q10Photo, Q11Photo,
